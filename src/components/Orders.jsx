...
// import useActions from "../hooks/useActions";
// import useOrders from "../hooks/useOreders";
// import usePrototypes from "../hooks/usePrototypes";
...
//         {orders.map(order =>{
//           const {id} = order;
//           const prorotype = prototypes.find(p => p.id === id);
//           // const click = () =>{
//           //   remove(id);
//           // }
//           return(<div className="item" key={id}>
//             <div className="img">
//               <video src={prorotype.thumbnail}></video>
//             </div>
//             <div className="content">
//               <p className="title">
//                 {prorotype.title} X {order.quantity}
//               </p>
//             </div>
//             <div className="action">
//               <p className="price">
//                  ${prorotype.price} * {order.quantity}
//               </p>
//               <button className="btn btn--link" onClick={()=>remove(id)}>
//                  <i className="icon icon--cross" />
//               </button>
